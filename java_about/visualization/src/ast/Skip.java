...
/**
 * Skip represents an empty command.
 *
 * @author       Christina P&ouml;pper
 * @version      1.0
 */
public final class Skip extends PrimitiveCommand {

    /**
     * Clones this instance.
     *
     * @return	the clone, which is a new <code>Skip</code> instance 
     */
    public Object clone () {
	return new Skip();
    }
     ...
     *
     * @return	the string representation of this skip command
     */
